-- DIVIDEND EXECUTE IDEMPOTENCY: re-run safe
-- 동일 dividend_id 재실행 시 추가 지급 금지

-- 1) dividend_distributions unique(dividend_id, user_id)
...
-- 2) rpc_execute_dividend: exists 체크 후 insert, distributions 성공 시에만 ledger
