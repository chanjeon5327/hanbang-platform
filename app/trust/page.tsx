...
export default function TrustPage() {
  return (
    <div className="pb-24" style={{ backgroundColor: BG }}>
      <header className="sticky top-0 z-10 flex items-center gap-3 px-4 py-3 border-b" style={{ borderColor: GOLD }}>
        ...
        <h1 className="body-lg font-bold" style={{ color: GOLD }}>투자 구조</h1>
      </header>

      <div className="py-8 space-y-10">
        {/* 1. 원장 불변 구조 */}
        <section className="rounded-2xl p-5 border" style={{ borderColor: GOLD }}>
          <h2 className="body font-bold mb-3 flex items-center gap-2" style={{ color: GOLD }}>
            <Shield size={20} />
            원장 불변 구조
          </h2>
          <p className="body-sm leading-relaxed" style={{ color: "rgba(197,160,89,0.95)" }}>
        ...
        {/* 2. 투자 → 결제 → 확정 → 정산 흐름 */}
        <section className="rounded-2xl p-5 border" style={{ borderColor: GOLD }}>
          <h2 className="body font-bold mb-4 flex items-center gap-2" style={{ color: GOLD }}>
            <CreditCard size={20} />
            투자 흐름
          </h2>
          <div className="space-y-4">
            {[
              ...
              <div key={step} className="flex gap-3 items-start">
                ...
                <div>
                  <p className="body-sm font-semibold" style={{ color: GOLD }}>{label}</p>
                  <p className="body-sm mt-0.5" style={{ color: "rgba(197,160,89,0.8)" }}>{desc}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <Link
          href="/"
          className="block w-full py-4 rounded-xl text-center body font-bold"
