...
const MOCK_REPORTED: ReportedMessage[] = [
  { id: '1', marketId: 'a1b2c3d4-e5f6-4789-a012-345678901234', marketTitle: '블루웨이 시즌3', userId: 'u1', userName: '투자자A', message: '부적절한 메시지 예시', reportedCount: 5, createdAt: '2024-01-15 14:30' },
  ...
  { id: '3', marketId: 'a1b2c3d4-e5f6-4789-a012-345678901234', marketTitle: '블루웨이 시즌3', userId: 'u3', userName: '투자자B', message: '욕설 포함 메시지', reportedCount: 8, createdAt: '2024-01-15 12:00' },
];
