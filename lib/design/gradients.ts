/**
 * Royal Blue 기반 그라디언트 8종
 */
export const gradients = {
  royalHero: 'linear-gradient(135deg, #1E3A8A 0%, #2563EB 50%, #3B82F6 100%)',
  royalSubtle: 'linear-gradient(180deg, rgba(30, 58, 138, 0.08) 0%, transparent 100%)',
  royalCard: 'linear-gradient(135deg, rgba(30, 58, 138, 0.06) 0%, rgba(59, 130, 246, 0.04) 100%)',
