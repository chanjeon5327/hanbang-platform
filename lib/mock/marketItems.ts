...
export const marketItems: MarketItem[] = [
  { id:'travel-j', title:'블루웨이 시즌3', creator:'크리에이터', category:'여행', price:12300, chgPct:2.4, tagMain:'한정판매형', momentum:'급상승', thumbnail: svgThumb('블루웨이 시즌3', '#0B1224', '#2563EB'), deadlineHours: 2.2 },
  { id:'chim', title:'라운지 나인', creator:'크리에이터', category:'토크', price:98120, chgPct:-1.1, tagMain:'일반형', momentum:'하락', thumbnail: svgThumb('라운지 나인', '#0B1224', '#7C3AED'), deadlineHours: 10.5 },
  ...
  { id:'muklab', title:'테이블 로그', creator:'크리에이터', category:'먹방', price:21050, chgPct:3.2, tagMain:'한정판매형', momentum:'급상승', thumbnail: svgThumb('테이블 로그', '#071021', '#F59E0B'), deadlineHours: 27.2 },
  ...
  { id:'kpop-stage', title:'사운드 플로어', creator:'스튜디오', category:'음악', price:73400, chgPct:2.1, tagMain:'한정판매형', momentum:'상승', thumbnail: svgThumb('사운드 플로어', '#071021', '#A855F7') },
  ...
  { id:'cinema-buster', title:'필름 하우스', creator:'스튜디오', category:'영화', price:88900, chgPct:3.5, tagMain:'한정판매형', momentum:'급상승', thumbnail: svgThumb('필름 하우스', '#0B1224', '#F59E0B') },
