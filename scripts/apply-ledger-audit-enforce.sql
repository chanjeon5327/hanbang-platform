-- =========================================================
-- apply-ledger-audit-enforce.sql
-- 원격 DB에 ledger_entries audit 강제 트리거 + RPC 패치 수동 적용
...
-- ------------------------------------------------------------
-- RPC 패치: audit 플래그 + LEDGER_WRITE audit 기록 (필수)
-- 트리거만 적용하면 기존 RPC가 ledger INSERT/UPDATE 시 실패함
-- ------------------------------------------------------------

-- rpc_place_orderbook_order
