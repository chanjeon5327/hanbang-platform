    ...
    <section className="bg-white rounded-2xl px-4 py-3.5 shadow-[0_2px_8px_rgba(0,0,0,0.06)] border border-[var(--toss-border)]">
      ...
      <div className="grid grid-cols-3 gap-2 mt-3">
        <div className="py-2 px-2 rounded-xl bg-[var(--toss-bg)] text-center">
          ...
          <div className="text-[13px] font-semibold text-[var(--toss-text)] mt-0.5 tabular-nums">₩12,350,000</div>
        </div>
        <div className="py-2 px-2 rounded-xl bg-[var(--toss-bg)] text-center">
          <div className="caption text-[var(--toss-text-secondary)]">출금가능</div>
          <div className="text-[13px] font-semibold text-[var(--toss-text)] mt-0.5 tabular-nums">₩3,470,000</div>
        </div>
        <div className="py-2 px-2 rounded-xl bg-[var(--toss-bg)] text-center">
          <div className="caption text-[var(--toss-text-secondary)]">수익</div>
          <div className="text-[13px] font-semibold text-[var(--accent-positive)] mt-0.5 tabular-nums">+₩522,000</div>
        </div>
      </div>
    </section>
  );
