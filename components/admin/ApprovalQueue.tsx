export default function ApprovalQueue() {
  return (
    <section className="bg-white rounded-[16px] p-5 shadow-[0_2px_8px_rgba(0,0,0,0.06)] border border-[var(--toss-border)]">
      <h2 className="body-lg font-bold text-[var(--toss-text)] mb-4">
        내가 처리해야 할 승인
      </h2>
        ...
        {[
          ...
          >
            <div>
              ...
              <div className="body-sm text-[var(--toss-text-secondary)] mt-0.5">
                {item.from} → {item.next}
              </div>
            </div>
            <button className="px-4 py-2 rounded-lg bg-[var(--toss-blue)] text-white body-sm font-medium hover:opacity-90 transition">
              검수 완료
            </button>
          </li>
        ))}
