  ...
  return (
    <section className="rounded-xl border overflow-hidden" style={{ backgroundColor: 'var(--upbit-panel)', borderColor: 'var(--upbit-border)' }}>
      ...
      <div className="p-4 space-y-4">
        ...
        <div>
          <h4 className="body-sm font-semibold mb-1" style={{ color: 'var(--upbit-text)' }}>정산 주기</h4>
          <p className="caption leading-relaxed" style={{ color: 'var(--upbit-text-dim)' }}>
            매월 1회 (전월 수익 기준). 익월 15일 경 정산·지급.
          </p>
        </div>
        <div>
          <h4 className="body-sm font-semibold mb-1" style={{ color: 'var(--upbit-text)' }}>수익 배분 구조</h4>
          <p className="caption leading-relaxed" style={{ color: 'var(--upbit-text-dim)' }}>
        ...
        <div className="flex gap-2 p-3 rounded-lg" style={{ backgroundColor: 'rgba(235, 77, 61, 0.08)', border: '1px solid rgba(235, 77, 61, 0.2)' }}>
          ...
          <div>
            <h4 className="body-sm font-semibold mb-0.5" style={{ color: 'var(--upbit-ask)' }}>리스크 고지</h4>
            <p className="caption leading-relaxed" style={{ color: 'var(--upbit-text-dim)' }}>
        ...
        <div>
          <h4 className="body-sm font-semibold mb-2" style={{ color: 'var(--upbit-text)' }}>과거 정산 (더미)</h4>
          <div className="space-y-2">
            {MOCK_PAST_DATA.map((d) => (
              <div key={d.period} className="flex justify-between caption">
