...
export default function ProductStorySection({
  ...
  return (
    <CardV5>
      ...
      <p className="body-sm leading-relaxed mb-6" style={{ color: 'var(--text-secondary)' }}>
        {creatorStory}
      </p>

      <h4 className="body-sm font-semibold mb-3" style={{ color: 'var(--text)' }}>
        성장 근거
      </h4>
      <ul className="space-y-2 mb-6">
        {[growthReason1, growthReason2, growthReason3].map((r, i) => (
          <li key={i} className="flex items-start gap-2 body-sm" style={{ color: 'var(--text-secondary)' }}>
      ...
      <div className="rounded-xl p-4 flex gap-2" style={{ backgroundColor: 'rgba(220, 38, 38, 0.08)' }}>
      ...
      <div className="pt-4">
        <h4 className="body-sm font-semibold mb-2" style={{ color: 'var(--text)' }}>
          배당 구조
        </h4>
