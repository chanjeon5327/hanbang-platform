...
export default function DividendSimulator({
  ...
  return (
    ...
    >
      ...
      <div className="mb-4">
        <label className="caption font-medium block mb-2" style={{ color: 'var(--text-secondary)' }}>
          투자금 (원)
        </label>
        <input
          type="number"
          ...
          className="w-full rounded-xl px-4 py-3 body font-bold tabular-nums border"
          style={{
      ...
      <button
        ...
        className="w-full rounded-[16px] py-4 body font-bold tap-scale"
        style={{
